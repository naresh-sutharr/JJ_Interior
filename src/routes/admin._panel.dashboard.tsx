    ...
    <div className="space-y-6 md:space-y-8 animate-fadeIn pb-24 md:pb-0 font-sans">
      ...
      >
        ...
        <div className="relative z-20">
          ...
          >
            Welcome, {operatorSettings?.name?.split(' ')[0] || 'Gopalram'}! ✨
          </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
        ...
        <div className="glass-card glass-card-hover p-5 md:p-6 flex items-center justify-between group">
