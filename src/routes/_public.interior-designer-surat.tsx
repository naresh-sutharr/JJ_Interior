...
export const Route = createFileRoute("/_public/interior-designer-surat")({
  component: InteriorDesignerSuratPage,
});

function InteriorDesignerSuratPage() {
  return (
    <ServicePageTemplate
      title="Interior Designer in Surat"
      metaTitle="Best Interior Designer in Surat | Premium Residential & Commercial"
      metaDescription="Looking for the best interior designer in Surat? Jay Jasol Interiors & Modutech offers luxury turnkey interior design services for homes and offices."
      urlPath="/interior-designer-surat"
      heroSubtitle="Local Expertise, Global Standards"
      heroImage={heroImage}
      overviewText={
        <>
          <p>As a leading <strong>interior designer in surat</strong>, Jay Jasol Interiors & Modutech brings over 25 years of expertise to projects across the city and surrounding regions. We understand the local climate, lifestyle preferences, and material availability, allowing us to deliver spaces that are both beautiful and highly practical.</p>
