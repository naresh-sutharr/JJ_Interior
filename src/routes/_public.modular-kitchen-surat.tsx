...
export const Route = createFileRoute("/_public/modular-kitchen-surat")({
  component: ModularKitchenSuratPage,
});

function ModularKitchenSuratPage() {
  return (
    <ServicePageTemplate
      title="Modular Kitchen Manufacturers in Surat"
      metaTitle="Modular Kitchen in Surat | Premium Designs by Jay Jasol"
      metaDescription="Top modular kitchen manufacturers in Surat. Get bespoke, ergonomic, and durable modular kitchens designed for your lifestyle."
      urlPath="/modular-kitchen-surat"
      heroSubtitle="Surat's Finest Modular Kitchens"
      heroImage={heroImage}
      overviewText={
        <>
          <p>As a leading <strong>modular kitchen manufacturers in surat</strong>, Jay Jasol Interiors & Modutech brings over 25 years of expertise to projects across the city and surrounding regions. We understand the local climate, lifestyle preferences, and material availability, allowing us to deliver spaces that are both beautiful and highly practical.</p>
