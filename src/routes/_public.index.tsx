...
export const Route = createFileRoute("/_public/")({
  head: () => ({
    meta: [
      { title: "Interior Designer in Surat | Jay Jasol Interiors & Modutech" },
      { name: "description", content: "Jay Jasol Interiors & Modutech offers premium interior design, modular kitchens, wardrobes, residential and commercial interiors in Surat, Gujarat." },
      { property: "og:title", content: "Premium Interior Designers in Surat | Jay Jasol Interiors & Modutech" },
      { property: "og:description", content: "Jay Jasol Interiors & Modutech offers premium interior design, modular kitchens, wardrobes, residential and commercial interiors in Surat, Gujarat." },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          "image": "https://jjinteriors.site/mukeshlogo.png",
          "@id": "https://jjinteriors.site",
          "url": "https://jjinteriors.site",
          "telephone": "+919898412998",
          "email": "mukesh.jj.interiors@gmail.com",
          "address": {
            "@type": "PostalAddress",
            "streetAddress": "[INSERT ACTUAL BUSINESS ADDRESS]",
            "addressLocality": "Surat",
            "addressRegion": "Gujarat",
            "addressCountry": "IN"
          },
          "areaServed": ["Surat", "Vesu", "Adajan", "Pal", "Piplod", "City Light", "Athwa"],
          "priceRange": "$$$"
        })
      },
      {
...
function Index() {
  ...
  const activeProjects = (dbProjects && dbProjects.length > 0) 
    ? dbProjects.slice(0, 4).map((p, i) => ({
        ...
        image: i % 2 === 0 ? residenceImage : villaImage,
        vertical: i % 2 === 0
      }))
    : [
        { name: "The Aster Residence", location: "Surat", year: "2026", type: "Luxury Residence", image: residenceImage, vertical: true },
        { name: "Villa Sereno", location: "Surat", year: "2025", type: "Modern Villa", image: villaImage, vertical: false },
        { name: "One Meridian", location: "Ahmedabad", year: "2026", type: "Contemporary Office", image: officeImage, vertical: false },
        { name: "Maison Privée", location: "Surat", year: "2025", type: "Bespoke Interior", image: bespokeImage, vertical: true },
      ];
  ...
  return (
    <>
      <section id="home" className="relative min-h-[100svh] overflow-hidden bg-hero text-hero-foreground">
        <img src={heroImage} alt="Premium Interior Designers in Surat" width={1920} height={1088} fetchPriority="high" className="hero-image absolute inset-0 h-full w-full object-cover" />
        ...
        <div className="section-shell relative flex min-h-[100svh] flex-col justify-end pb-14 pt-32 md:pb-16">
          <p className="hero-copy mb-7 text-[10px] uppercase tracking-[.3em] text-hero-foreground/75">Premium Interior Design & Modular Solutions Studio</p>
          <h1 className="hero-title max-w-5xl display-serif text-[clamp(3rem,8vw,7.6rem)] leading-[.88]">PREMIUM INTERIOR<br />DESIGNERS IN SURAT</h1>
          <div className="hero-copy mt-9 flex flex-col items-start justify-between gap-8 border-t border-hero-foreground/35 pt-6 md:flex-row md:items-end">
            <p className="max-w-md text-sm font-light leading-7 text-hero-foreground/80 md:text-base">Jay Jasol Interiors & Modutech is a premium interior design and modular solutions studio serving Surat, Gujarat.</p>
      ...
      <section className="bg-stone py-28 md:py-44"><div className="section-shell reveal mx-auto max-w-5xl text-center"><p className="mb-12 text-[10px] uppercase tracking-[.25em] text-muted-foreground">Client Perspective</p><blockquote className="display-serif text-[clamp(2.1rem,4.5vw,5rem)] leading-[1.12]">“JAY JASOL INTERIORS & MODUTECH understood that true luxury is not excess. It is the feeling that every detail belongs exactly where it is.”</blockquote><p className="mt-10 text-[10px] uppercase tracking-[.22em]">Private Residence · Surat</p></div></section>

      <section id="contact" className="relative min-h-[85vh] overflow-hidden bg-hero text-hero-foreground">
        <img src={heroImage} alt="JAY JASOL INTERIORS & MODUTECH luxury residence at dusk" width={1920} height={1088} loading="lazy" className="absolute inset-0 h-full w-full scale-105 object-cover opacity-25" />
