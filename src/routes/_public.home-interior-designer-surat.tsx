...
export const Route = createFileRoute("/_public/home-interior-designer-surat")({
  component: HomeInteriorDesignerSuratPage,
});

function HomeInteriorDesignerSuratPage() {
  return (
    <ServicePageTemplate
      title="Home Interior Designer in Surat"
      metaTitle="Home Interior Designer in Surat | Luxury Villa & Apartment Interiors"
      metaDescription="Transform your living space with the leading home interior designer in Surat. We specialize in luxury villas, apartments, and bespoke furniture."
      urlPath="/home-interior-designer-surat"
      heroSubtitle="Crafting Beautiful Homes in Surat"
      heroImage={heroImage}
      overviewText={
        <>
          <p>As a leading <strong>home interior designer in surat</strong>, Jay Jasol Interiors & Modutech brings over 25 years of expertise to projects across the city and surrounding regions. We understand the local climate, lifestyle preferences, and material availability, allowing us to deliver spaces that are both beautiful and highly practical.</p>
